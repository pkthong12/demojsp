<%-- 
    Document   : checkout
    Created on : Mar 6, 2023, 1:09:09 PM
...
<html>
    <head>
        ...
        <title>${sessionScope.configs.tenweb} - Thanh toán</title>
    ...
    <body>
        <div class="container wrapper">
            <div style="    margin: 2% 0;" class="row cart-head">
                <div class="container">
                    <div style="display: flex;    justify-content: center;
                         align-items: center;">
                        <img style="width: 63px;" src="img\ciu.png" alt="alt"/>
                        <h1 style="font-size:25px;"><a style=" text-decoration: none" href="index">Nhà sách DB</a></h1>
                    </div>
                </div>
            </div>    
            <div class="row cart-body">
                <form class="form-horizontal" onsubmit="return checkout()" action="checkout" method="post">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6">
                        <!--REVIEW ORDER-->
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                Review Order <div class="pull-right"><small><a class="afix-1" href="carts">Edit Cart</a></small></div>
                            </div>
                            <div class="panel-body">
                                <c:forEach items="${requestScope.code}" var="book">
                                    <div class="form-group"><hr /></div>
                                    <div class="form-group">
                                        <div class="col-sm-3 col-xs-3">
                                            <img class="img-responsive" src="${book.getKey().img}" />
                                        </div>
                                        <div class="col-sm-6 col-xs-6">
                                            <div style="color: #3b71ca;" class="col-xs-12">${book.getKey().tensach}</div>
                                            <div class="col-xs-12"><small>Số lượng: <span>${book.getValue()}</span></small></div>
                                        </div>
                                        <div class="col-sm-3 col-xs-3 text-right">
                                            <input readonly="" type="hidden" name="price" value="${(book.getKey().giaban - book.getKey().giaban*book.getKey().giamgia/100)*book.getValue()}">
                                            <h6 ><fmt:formatNumber pattern="###,###" value="${(book.getKey().giaban - book.getKey().giaban*book.getKey().giamgia/100)*book.getValue()}"/>₫ </h6>
                                        </div>
                                    </div>
                                </c:forEach>
                                <div class="form-group"><hr /></div>
