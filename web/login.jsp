            ...
            <div id="signupbox" style="display:none; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body" >
                        <form id="signupform" class="form-horizontal" role="form" onsubmit="return checkPA()" action="signup" method="get">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="password" id="p1" required="" class="form-control" name="passwd" placeholder="Password">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-md-3 control-label">Nhập lại mật khẩu</label>
                                <div class="col-md-9">
                                    <input type="password" id="p2" required="" class="form-control" name="passwd2" placeholder="Repassword">
                                </div>
                            </div>
                            <div class="form-group">
                                <!-- Button -->                                        
